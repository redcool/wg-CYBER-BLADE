...
const FILES = [
    ...
    'bosses', 'waves', 'passives', 'levelUpCards', 'weaponStats', 'charStats', 'difficulty', 'debug', 'rarityColors', 'rarity', 'audio', 'classes', 'level_duration', 'system', 'synergies', 'bulletTypes', 'sceneItems',
];
